...
$id= $_GET['Id_kota']; 
$query = "SELECT * FROM `apl_kota` WHERE Id_kota='".$id."'";
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_kotaupdate2.php" enctype="multipart/form-data">
              <div class="box-body">
				<div class="form-group">
                  <label for="exampleInputEmail1">Kode Kota</label>
                    <input class="form-control" id="exampleInputEmail1" placeholder="Nama Kota" name="Id_kota" type="text"  value="<?php echo $id?>" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Kota</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama Kota" name="nama" type="text"  value="<?php echo $nama?>">
                </div>
				<center>
