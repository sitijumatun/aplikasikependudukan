...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data dawis
        <small>Silakan Administrasi Data dawis</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Data dawis</a></li>
      </ol>
    </section>
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambahkan Data dawis</h3>
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_dawistambah.php" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama dawis</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama dawis" name="nama" type="text">
                </div>
				<center>
            ...
            <div class="box-header">
              <h3 class="box-title">Detail Data dawis</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><center>Kode dawis</center></th>
                  <th><center>Nama dawis</center></th>
                ...
                <tbody>
					...
					$query = "SELECT * FROM apl_dawis";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
							echo "<td>".$data['Id_dawis']."</td>";
							echo "<td>".$data['Nama_dawis']."</td>";
							
					?>
							<td><?php echo"<center><a href='apl_dawisupdate.php?Id_dawis=".$data['Id_dawis']."'><i class='fa fa-fw fa-edit'></i>Edit</a>&nbsp
								<a href='apl_dawisdelete.php?Id_dawis=".$data['Id_dawis']."'><i class='fa fa-fw fa-trash'></i>Delete</a></center>"; ?></td>
							<?php echo "</tr>";
					}
					?>
