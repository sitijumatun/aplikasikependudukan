...
$id= $_GET['Id_dawis']; 
$query = "SELECT * FROM `apl_dawis` WHERE Id_dawis='".$id."'";
$sql = mysqli_query($conn,$query);
while($data = mysqli_fetch_array($sql)){
		$nama = $data['Nama_dawis'];
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_dawisupdate2.php" enctype="multipart/form-data">
              <div class="box-body">
				<div class="form-group">
                  <label for="exampleInputEmail1">Kode dawis</label>
                    <input class="form-control" id="exampleInputEmail1" placeholder="Nama dawis" name="Id_dawis" type="text"  value="<?php echo $id?>" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama dawis</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama dawis" name="nama" type="text"  value="<?php echo $nama?>">
                </div>
				<center>
