	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
			   ...
			   <form role="form" class="center" method="post" action="apl_rtsatu2.php" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama RT" name="nama" type="text">
                </div>
				<center>
