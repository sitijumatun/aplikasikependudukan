...
$kodeRT= $_GET['Id_RT']; 
$query = "SELECT * FROM `apl_rt` WHERE Id_RT='".$kodeRT."'";
...
$nik= $_GET['nik']; 
$query2 = "SELECT * FROM `apl_penduduk` WHERE NIK='".$nik."'";
$sql2 = mysqli_query($conn,$query2);
while($data2 = mysqli_fetch_array($sql2)){
		$nama2 = $data2['Nama'];
		$jeniskelamin = $data2['Jenis_kelamin'];
		 $tempatlahir = $data2['Tempat_lahir'];
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_pendudukeditaksi.php" enctype="multipart/form-data">
              <div class="box-body">
				  <div class="form-group">
                  <label for="exampleInputEmail1">RT</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="NIP" value="<?php echo $nama; ?>"name="rt" type="text" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">NIK</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="NIK" value="<?php echo $nik; ?>" name="nik" type="text">
                </div>
				 <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama Lengkap" value="<?php echo $nama2; ?>" name="nama" type="text">
                </div>
				 <div class="form-group">
                  <label for="exampleInputEmail1">Tempat Lahir</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Tempat Lahir" value="<?php echo $tempatlahir; ?>" name="tempatlahir" type="text">
                </div>
				 <div class="form-group">
                  <label for="exampleInputEmail1">Tanggal Lahir</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Tanggal Lahir" name="tanggallahir" value="<?php echo $tanggallahir; ?>"type="date">
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Pekerjaan" name="pekerjaan" value="<?php echo $pekerjaan; ?>"type="text">
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  <label>Dawis</label>
                  <select class="form-control" name="dawis">
                    <?php
							include "../apl_koneksi.php";
							$query2="select * from apl_dawis";
							$hasil2=mysqli_query($conn, $query2);
							while ($data2=mysqli_fetch_array($hasil2))
							{
							
							echo "<option>".$data2['Nama_dawis']."</option>";
							}
							?>
                  </select>
                </div> 
				...
				<center>
                <button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-external-link"></i>  perbarui Data</button>
                </center>
              </div>
              <!-- /.box-body -->
