...
$query = "SELECT * FROM `apl_kelurahan` WHERE Id_kelurahan='".$id."'";
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Perbarui Data kelurahan</h3>
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_kelurahanupdate2.php" enctype="multipart/form-data">
              <div class="box-body">
				<div class="form-group">
                  <label for="exampleInputEmail1">Kode kelurahan</label>
                    <input class="form-control" id="exampleInputEmail1" placeholder="Nama kelurahan" name="Id_kelurahan" type="text"  value="<?php echo $id?>" readonly>
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama kelurahan" name="nama" type="text"  value="<?php echo $nama?>">
                </div>
				<center>
