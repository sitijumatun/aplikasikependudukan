	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
             <a href="apl_pegawaitambahform.php"><button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-external-link"></i>  Tambahkan Data</button></a>
			  <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					$query = "SELECT apl_pegawai.NIP as nip , apl_pegawai.Nama as nama , apl_pegawai.jabatan as jabatan, apl_kelurahan.Nama_kelurahan as kelurahan, apl_pegawai.Foto as foto from apl_pegawai , apl_kelurahan where apl_pegawai.Id_Kelurahan = apl_kelurahan.Id_kelurahan ";
					...
					?>
							<td><?php echo"<center><a href='apl_pegawaiupdate.php?nip=".$data['nip']."'><i class='fa fa-fw fa-edit'></i>Edit</a>&nbsp
								<a href='apl_pegawaidelete.php?nip=".$data['nip']."'><i class='fa fa-fw fa-trash'></i>Delete</a>&nbsp
								<a href='apl_pegawaidetail.php?nip=".$data['nip']."&kelurahan=".$data['kelurahan']."'><i class='fa fa-fw fa-eye'></i>Detail</a></center>"; ?></td>
							<?php echo "</tr>";
					}
					?>
