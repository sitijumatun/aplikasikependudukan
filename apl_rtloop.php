...
$sqlkelurahan = "SELECT Nama_RW as rw FROM apl_rw WHERE Id_RW='$kodekel'";
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
			   ...
			   <form role="form" class="center" method="post" action="apl_RTloop2.php" enctype="multipart/form-data">
              <div class="box-body">
				   <div class="form-group">
                  <label for="exampleInputEmail1">RW yang dipilih</label>
                  <input class="form-control" id="exampleInputEmail1" value="<?php echo $satu;?>" name="rw" type="text" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Jumlah RT yang akan ditambahkan</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Jumlah RT yang akan ditambahkan" name="jumlah" type="text">
                </div>
				<center>
