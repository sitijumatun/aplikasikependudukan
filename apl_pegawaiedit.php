...
if(move_uploaded_file($tmp, $path)){ 
  $query = "UPDATE `apl_pegawai` SET `Nama` = '".$nama."', `Jenis_kelamin` = '".$jeniskelamin."', `jabatan` = '".$jabatan."', `Alamat` = '".$alamat."', `Id_Kelurahan` = '".$idkelurahan."' ,`Foto` = '".$fotobaru."'  WHERE `apl_pegawai`.`NIP` = '".$nip."'";
