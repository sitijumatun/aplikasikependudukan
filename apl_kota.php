...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Kota
        <small>Silakan Administrasi Data Kota</small>
      </h1>
      <ol class="breadcrumb">
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambahkan Data Kota</h3>
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_kotatambah.php" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Kota</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama Kota" name="nama" type="text">
                </div>
				<center>
            ...
            <div class="box-header">
              <h3 class="box-title">Detail Data Kota</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					?>
							<td><?php echo"<center><a href='apl_kotaupdate.php?Id_kota=".$data['Id_kota']."'><i class='fa fa-fw fa-edit'></i>Edit</a>&nbsp
								<a href='apl_kotadelete.php?Id_kota=".$data['Id_kota']."'><i class='fa fa-fw fa-trash'></i>Delete</a></center>"; ?></td>
							<?php echo "</tr>";
					}
					?>
