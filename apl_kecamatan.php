...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data kecamatan
        <small>Silakan Administrasi Data kecamatan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Data kecamatan</a></li>
      </ol>
    </section>
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambahkan Data Kecamatan</h3>
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="apl_kecamatantambah.php" enctype="multipart/form-data">
              <div class="box-body">
				<div class="form-group">
                  ...
                  <select class="form-control" name="kota">
                    <?php
							...
							$query2="select * from apl_kota";
							$hasil2=mysqli_query($conn, $query2);
							while ($data2=mysqli_fetch_array($hasil2))
							{
							
							echo "<option>".$data2['Nama_kota']."</option>";
							}
							?>
                  </select>
                </div> 
                <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama kecamatan" name="nama" type="text">
                </div>
				<center>
            ...
            <div class="box-header">
              <h3 class="box-title">Detail Data kecamatan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php
					include "../apl_koneksi.php";
					$query = "SELECT apl_kecamatan.Id_kecamatan as kode, apl_kecamatan.Nama_kecamatan as namakec, apl_kota.Nama_kota as kota FROM apl_kecamatan, apl_kota WHERE apl_kecamatan.Id_kota = apl_kota.Id_kota";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
							echo "<td>".$data['kode']."</td>";
							echo "<td>".$data['namakec']."</td>";
							echo "<td>".$data['kota']."</td>";
							
					?>
							<td><?php echo"<center><a href='apl_kecamatanupdate.php?Id_kecamatan=".$data['kode']."'><i class='fa fa-fw fa-edit'></i>Edit</a>&nbsp
								<a href='apl_kecamatandelete.php?Id_kecamatan=".$data['kode']."'><i class='fa fa-fw fa-trash'></i>Delete</a></center>"; ?></td>
							<?php echo "</tr>";
					}
					?>
