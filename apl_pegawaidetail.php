  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	 ...
	 <section class="content">
		...
		<div class="row">
		 <center> <img class="img-circle" style="width:200px;height:200px" src="images/<?php echo $foto;?>" alt="User Avatar"></center>
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="widget-user-header bg-yellow">
              <div class="widget-user-image">
                <img class="img-circle" src="images/<?php echo $foto;?>" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama kecamatan" name="nama" type="text" value="<?php echo $nip;?>" disabled>
                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">JENIS KELAMIN</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama kecamatan" name="nama" type="text" value="<?php echo $jeniskelamin;?>" disabled>
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">ALAMAT</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama kecamatan" name="nama" type="text" value="<?php echo $alamat;?>" disabled>
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">KANTOR KELURAHAN</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="Nama kecamatan" name="nama" type="text" value="<?php echo $kelurahan;?>" disabled>
                </div>
		   ...
		   <a href="apl_pegawai.php"><button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-external-link"></i> Kembali</button></a>
            </div>
